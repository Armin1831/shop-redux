...
// components && types
import HomeCardListHeader from "./HomeCardListHeader";
...
const HomeCardList = ({title, Card, cardList, type}: CategoryCardListProps | ProductCardListProps) => {
    return (
        <>
            <HomeCardListHeader title={title}/>
