        ...
        <div className="owl-carousel vendor-carousel owl-loaded owl-drag">
            <div className="owl-stage-outer">
                <div
                    className="owl-stage"
                    style={{
                        transform: 'translate3d(-417px, 0px, 0px)',
                        transition: 'all 1s ease 0s',
                        width: '4174px'
                    }}
                >
                    <div className="owl-item cloned" style={{width: '179.667px', marginRight: '29px'}}>
                    ...
                    <div className="owl-item cloned active" style={{width: '179.667px', marginRight: '29px'}}>
                        <div className="bg-light p-4">
                    ...
                    <div className="owl-item active" style={{width: '179.667px', marginRight: '29px'}}>
                        <div className="bg-light p-4">
                    ...
                    <div className="owl-item" style={{width: '179.667px', marginRight: '29px'}}>
                        <div className="bg-light p-4">
                            <img src="../../assets/img/vendor-3.jpg" alt=""/>
                        </div>
                    </div>
